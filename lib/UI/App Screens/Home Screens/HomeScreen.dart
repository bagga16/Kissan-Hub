...
import 'package:kissan_hub/UI/App%20Widgets/ProductItem.dart';

// class HomeScreen extends StatelessWidget {
//   final HomeController _homeController = Get.put(HomeController());
//  final List<String> products = ['چاول', 'سیب', 'گندم', 'مٹر']; 
//   @override
...
//                 // Profile Image
//                 CircleAvatar(
//                   backgroundImage: AssetImage('assets/images/R1.png'), // Placeholder
//                   radius: 25,
//                 ),
//               ],
//             ),
...
//              // Get.to(() => CompanyListScreen(  productName: _homeController.products[index].name));
//           },
...
class HomeScreen extends StatelessWidget {
  final HomeController _homeController = Get.put(HomeController());
  final List<String> products = ['چاول', 'سیب', 'گندم', 'مٹر'];  // List of products (e.g. rice, apple, wheat)
