...
//             SizedBox(height: 25),
//             // Category List (e.g., types of rice)
//             Expanded(
//               child: Obx(() {
...
//                       onTap: () {
//                         // When a category is tapped, navigate to Company List Screen
//                         categoryController.selectCategory(categoryController.categories[index]);
